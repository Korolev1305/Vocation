...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        PageAdapter recyclerAdapter = new PageAdapter(this, databaseHelper.getAddressDao().getAllData());
        recyclerAdapter.setOnDeleteListener(this);
        recyclerView.setAdapter(recyclerAdapter);
    }

    @Override
    public void onDelete(Address dataModel) {
        databaseHelper.getAddressDao().delete(dataModel);
    }
    */
}
